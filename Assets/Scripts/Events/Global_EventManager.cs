...
public class Global_EventManager : MonoBehaviour
{
    ...
    public static Action eventUseAbility;
    public static Action<float> eventAbilityCooldown;
    ...
    public static void CallOnUseAbility()
    {
        eventUseAbility?.Invoke();
    }
    public static void CallOnAbilityCooldown(float time)
    {
        eventAbilityCooldown?.Invoke(time);
    }
