...
namespace TanksEngine.LevelCreator
{
    ...
    //}
    /// <summary>
    /// Реализует сборку игровой локации по
    ...
    public class LevelEditor : MonoBehaviour
    {
        ...
        /// <summary>
        /// Сохраняет id выбранного дизайна лелвела (leveltype)
        /// </summary>
        ...
        /// <summary>
        /// Собирает уровень из блоков выбранного дизайна.
        /// Отдельно собирается внешняя часть, отдельно внутренняя.
        /// </summary>
